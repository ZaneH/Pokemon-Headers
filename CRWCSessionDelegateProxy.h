...
+ (id)performSwizzledWCSessionMessageData:(id)arg1 data:(id)arg2 replyHandler:(id)arg3 errorHandler:(id)arg4;
+ (id)performSwizzledWCSessionSendMessage:(id)arg1 message:(id)arg2 replyHandler:(id)arg3 errorHandler:(id)arg4;
...
+ (void)sendMessageDataForWCSession:(id)arg1 data:(id)arg2 replyHandler:(id)arg3 errorHandler:(id)arg4 dispatch:(id)arg5;
+ (void)sendMessageForWCSession:(id)arg1 message:(id)arg2 replyHandler:(id)arg3 errorHandler:(id)arg4 dispatch:(id)arg5;
...
- (void)session:(id)arg1 didReceiveMessage:(id)arg2 replyHandler:(id)arg3;
- (void)session:(id)arg1 didReceiveMessageData:(id)arg2;
- (void)session:(id)arg1 didReceiveMessageData:(id)arg2 replyHandler:(id)arg3;
