...
+ (id)defaultOptions;
+ (id)firstPartyOptionsWithFallbackHandler:(id)arg1;
+ (id)optionsWithExtraParams:(id)arg1;
+ (id)optionsWithExtraParams:(id)arg1 fallbackHandler:(id)arg2;
+ (id)silentOptions;
- (void).cxx_destruct;
...
@property(readonly, nonatomic) id fallbackHandler; // @synthesize fallbackHandler=_fallbackHandler;
